...
namespace DC_SYSTEM.Windows
{
	...
	public partial class Menu_Win : Window
	{
		...
		{
			firstImage.Source = new BitmapImage(new Uri("C:/Users/Avital/Desktop/DeliveryCharitySystem (2)/DeliveryCharitySystem/DeliveryCharitySystem/DeliveryCharitySystem/DC_SYSTEM/HomePagePic/" + imageIndex + ".jpg"));
			if (++imageIndex == 5)
				imageIndex = 1;
